...
function contactarCliente(index) {
    ...
    const mensaje = `Hola ${reserva.nombre}, te contactamos desde BarberShop  respecto a tu reserva del ${formatDate(reserva.fecha)} a las ${reserva.hora}.`;
    
    const urlWhatsApp = `https://wa.me/${3152606861}?text=${encodeURIComponent(mensaje)}`;
